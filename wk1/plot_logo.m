...
% adjust axes limits so that the axes are tight around the logo
ax.XLim = [1 201];
ax.YLim = [1 201];
ax.ZLim = [-53.4 160];
...
% Change the position of the axes and the x, y, and z aspect ratio to fill
% the extra space in the figure window.
ax.Position = [0 0 1 1];
ax.DataAspectRatio = [1 1 .9];

% Create lights to illuminate the logo. The light itself is not visible but
% its properties can be set to change the appearance of any patch or 
